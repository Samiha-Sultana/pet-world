...
-->
  ...
  <li>
  <li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='update_product.php'"> <span class="glyphicon glyphicon-edit pull-left"></span> Update Product </button></li>
  <li>
  
  <li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='delete_product.php'"> <span class="glyphicon glyphicon-edit pull-left"></span> Delete Product </button></li>
  <li>
  ...
  <ul class="dropdown-menu" style="width:240px">
    <li><a href="pet_list.php"><strong>Pet List</strong> </a></li>
 <li><a href="pet_food_list.php"><strong> Pet Food List</strong></a></li>
 <li><a href="pet_toy_list.php"><strong> Pet Toy List</strong></a></li>
 <li><a href="pet_clothes_list.php"><strong> Pet Clothes List</strong></a></li>
   </ul></li>
