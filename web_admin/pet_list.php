...
<body>
  <?php include("include/header.php");?>
	...
	<h1>Pet list / Page <?php echo $page;?> </h1></div><br>
...
$result=mysqli_query($connection,"select product_id,image, product_name,price from products  where product_type like '%Animal%' order by time Desc Limit $page1,10")or die ("query 1 incorrect.....");
...
<a class=' btn btn-success' href='pet_list.php?product_id=$product_id&action=delete'>Delete</a>
</td></tr>";
}
...
<li><a class="label-info" href="pet_list.php?page=<?php echo $b;?>"><?php echo $b." ";?></a></li></ul>
<?php	
}
?>
</nav>
