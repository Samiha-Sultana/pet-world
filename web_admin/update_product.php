...
mysqli_query($connection,"UPDATE products SET product_name ='$product_name',details ='$details',image ='$picture_name',product_type='$product_type', price =$price, c_price =$c_price,brand='$brand', tags='$tags' WHERE product_name = '$product_name' AND product_type ='$product_type' AND details='$details';") or die ("query incorrect");
...
<body>
	...
	<h1><span class="glyphicon glyphicon-tag"></span> Update Product  </h1></div><br>
