...
mysqli_query($connection,"DELETE FROM products WHERE product_name ='$product_name' AND product_type='$product_type' AND brand='$brand';") or die ("query incorrect");

 header("location: sumit_form.php?success=1");
 
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif" || $picture_type=="image/jfif")
{
...
<body>
	...
	<h1><span class="glyphicon glyphicon-tag"></span> Delete Product  </h1></div><br>
	<div class="panel-body" style="background-color:#E6EEEE;">
		<div class="col-lg-7">
        <div class="well">
        <form action="delete_product.php" method="post" name="form" enctype="multipart/form-data">
        <p>Title</p>
...
<div align="center">
    ...
    <button type="submit" name="submit" id="submit" class="btn btn-success" style="width:150px; height:60px""> Delete Product</button>
    </div>
        </form>
