...
<h2 class="title text-center">Pet Clothes</h2>
	<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%Cloth%' order by rand(), time Desc LIMIT 0,12")or die("Query 1 is inncorrect..........");
