...
<h2 class="title text-center">Pet Food Items</h2>
	<?php 
$cosmetics=mysqli_query($connection,"select product_id, product_name, image, price, c_price from products where product_type like '%Food%' order by rand(), time Desc LIMIT 0,12")or die("Query 1 is inncorrect..........");
